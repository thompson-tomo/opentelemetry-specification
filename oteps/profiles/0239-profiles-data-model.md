...
frames with Function.function_name fully matching the following
regular expression will be dropped from the samples, along with their successors.

##### Field `keep_frames`

Index into string table.
frames with Function.function_name fully matching the following
regular expression will be kept, even if it matches drop_frames.
